                                            ...
                                            <div class="testimonial-content">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <img class="testimonial-author-img ml-3"
                                                        src="{{ asset('/admin/theme/images/avatar/1.png') }}"
                                                        alt="" />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="widget-timeline">
                                    <ul class="timeline">
                                        <li>
                                            ...
                                            <a class="timeline-panel text-muted" href="{{ url('#') }}">
                                ...
                                <div class="card-action">
                                    <div class="dropdown custom-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="{{ url('#') }}">Option 1</a>
                                            <a class="dropdown-item" href="{{ url('#') }}">Option 2</a>
                                            <a class="dropdown-item" href="{{ url('#') }}">Option 3</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
